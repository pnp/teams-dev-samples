# Action Preview Bot - `actionPreviewBot`
...
3. Give the bot a handle (ex: `actionPreviewBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://9e79267.ngrok.io/api/messages`
