# Msgext Bot Document Review Bot - `msgextBotDocumentReviewBot`
...
3. Give the bot a handle (ex: `msgextBotDocumentReviewBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://5a204033d78f.ngrok.io/api/messages`
