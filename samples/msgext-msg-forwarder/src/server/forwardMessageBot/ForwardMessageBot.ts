...
import ForwardMessageMessageExtension from "../forwardMessageMessageExtension/ForwardMessageMessageExtension";
import { DialogSet, DialogState } from "botbuilder-dialogs";
// Initialize debug logging module
const log = debug("msteams");

/**
 * Implementation for Forward Message Bot
 */
@BotDeclaration(
    "/api/messages",
    new MemoryStorage(),
...
export class ForwardMessageBot extends TeamsActivityHandler {

    private readonly conversationState: ConversationState;
    /** Local property for ForwardMessageMessageExtension */
    @MessageExtensionDeclaration("forwardMessageMessageExtension")
    private _forwardMessageMessageExtension: ForwardMessageMessageExtension;
    ...
    public constructor(conversationState: ConversationState) {
        super();
        // Message extension ForwardMessageMessageExtension
        this._forwardMessageMessageExtension = new ForwardMessageMessageExtension();
