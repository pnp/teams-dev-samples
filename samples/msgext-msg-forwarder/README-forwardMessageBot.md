# Forward Message Bot - `forwardMessageBot`
...
3. Give the bot a handle (ex: `forwardMessageBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://teamsmsgforward.azurewebsites.net/api/messages`
