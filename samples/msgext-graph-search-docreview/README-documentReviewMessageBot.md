# Document Review Message Bot - `documentReviewMessageBot`
...
3. Give the bot a handle (ex: `documentReviewMessageBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://docreviewmsgext.azurewebsites.net/api/messages`
