...
export interface IPdfUploaderTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IPdfUploaderTabRemoveProps {
 ...
 */
export class PdfUploaderTabRemove  extends TeamsBaseComponent<IPdfUploaderTabRemoveProps, IPdfUploaderTabRemoveState> {
