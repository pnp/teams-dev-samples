...
/**
 * Implementation of Meeting Details configuration page
 */
export const MeetingDetailsTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: pages.config.SaveEvent) => {
        ...
        pages.config.setConfig({
            contentUrl: host + "/meetingDetailsTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/meetingDetailsTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "Meeting Details",
            removeUrl: host + "/meetingDetailsTab/remove.html?theme={theme}",
