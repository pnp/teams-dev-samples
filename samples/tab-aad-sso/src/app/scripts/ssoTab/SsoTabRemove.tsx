...
export interface ISsoTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ISsoTabRemoveProps extends ITeamsBaseComponentProps {
 ...
 */
export class SsoTabRemove  extends TeamsBaseComponent<ISsoTabRemoveProps, ISsoTabRemoveState> {
