...
/**
 * Implementation of Pronunce name configuration page
 */
export const PronunceNameTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: microsoftTeams.settings.SaveEvent) => {
        ...
        microsoftTeams.settings.setSettings({
            contentUrl: host + "/pronunceNameTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/pronunceNameTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "Pronunce name",
            removeUrl: host + "/pronunceNameTab/remove.html?theme={theme}",
