# Doc Review Action Extension Bot - `docReviewActionExtensionBot`
...
3. Give the bot a handle (ex: `docReviewActionExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://msgextactiondocreview.azurewebsites.net/api/messages`
