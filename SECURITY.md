...
To report a vulnerability, please [create an issue](https://github.com/pnp/teams-dev-samples/issues/new/choose) and tag the issue as `vulnerability-suspected`.
